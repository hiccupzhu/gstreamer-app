...
#define SAFE_FREE(x) \
        do{\
            if((x) != NULL){\
                if(DEBUG_PRINT) g_print("SAFE_FREE " #x "\n");\
                free((x));\
                (x) = NULL;\
            }\
        }while(0)
...
#define SAFE_CLOSE(x) \
        do{\
            if((x) != -1){\
                if(DEBUG_PRINT) g_print("SAFE_CLOSE " #x "\n");\
                close((x));\
                (x) = -1;\
            }\
        }while(0)
...
#define SAFE_FCLOSE(x) \
        do{\
            if(DEBUG_PRINT) g_print("SAFE_FCLOSE " #x "\n");\
            if((x) != NULL){\
                fclose((x));\
                (x) = NULL;\
            }\
...
#define SAFE_GQUEUE_FREE(x) \
    do{\
    if((x)){\
        if(DEBUG_PRINT) g_print("SAFE_GQUEUE_FREE "#x "[%p]\n", (x));\
        g_queue_free((x));\
        (x) = NULL;\
    }}while(0)
#endif
...
#define SAFE_GMUTEX_FREE(x) \
    do{\
    if((x)){\
        if(DEBUG_PRINT) g_print("SAFE_GMUTEX_FREE " #x "[%p]\n", (x));\
        g_mutex_free((x));\
        (x) = NULL;\
    }}while(0)
#endif
...
#define SAFE_GCOND_FREE(x) \
    do{\
    if((x)){\
        if(DEBUG_PRINT) g_print("SAFE_GCOND_FREE " #x "[%p]\n", (x));\
        g_cond_free((x));\
        (x) = NULL;\
    }}while(0)
#endif
